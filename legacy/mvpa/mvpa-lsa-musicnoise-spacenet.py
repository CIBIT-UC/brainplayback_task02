...
results1.to_csv(os.path.join(dataset_dir, 'mvpa-lsa-spacenet-results-1.csv'), index=False)
print('saved accuracy results to mvpa-lsa-spacenet-results-1.csv')

# %%
coef_img = decoder.coef_img_

# save coef_img
coef_img.to_filename(os.path.join(dataset_dir, 'mvpa-lsa-spacenet_coefimg.nii.gz'))
print('saved coef_img to mvpa-lsa-spacenet_coefimg.nii.gz')

# export decoder
import pickle
with open(os.path.join(dataset_dir, 'mvpa-lsa-spacenet-decoder.pkl'), 'wb') as f:
    pickle.dump(decoder, f)
print('saved decoder to mvpa-lsa-spacenet-decoder.pkl')
