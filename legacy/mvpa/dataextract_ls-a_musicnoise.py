...
from de_functions import ls_a_musicnoise, ls_a_musicnoise_confounds
...
Parallel(n_jobs=13)(delayed(ls_a_musicnoise_confounds)(root_dir, subj, '02a', run) for subj, run in combinations)
