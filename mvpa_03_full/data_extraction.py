...
from functions import ls_a_full_confounds

# define paths
root_dir = '/Volumes/T7/BIDS-BRAINPLAYBACK-TASK2'
fmriprep_dir = os.path.join(root_dir, 'derivatives','fmriprep23')
output_dir = os.path.join(root_dir, 'derivatives','mvpa_03_full')
...
Parallel(n_jobs=2)(delayed(ls_a_full_confounds)(root_dir, output_dir, subj, '02a', run) for subj, run in combinations)
