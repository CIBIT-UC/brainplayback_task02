#%% Import libraries
import os
from data_extraction_functions import get_mask, clean_func_image, extract_samples_with_atlas, convert_samples_to_features
...
output_feat_dir = os.path.join(data_root, 'derivatives', 'mvpa_05_factors_bold', 'features')
...
for subject in ['12', '13', '14', '15', '16', '17']:
    for run in ['1', '2', '3', '4']:
        img_crop = clean_func_image(fmriprep_dir, output_func_dir, img_mask, subject, run, False)
        samples = extract_samples_with_atlas(img_crop, output_samples_dir, 'pauli', subject, run)
