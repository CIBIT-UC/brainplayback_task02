#%% Import libraries
import os
from data_extraction_functions import edit_events, extract_samples, get_mask, clean_func_image, extract_samples_with_atlas, convert_samples_to_features
...
output_feat_dir = os.path.join(data_root, 'derivatives', 'mvpa_06_full_bold', 'features_stab_smaller')

#%% Iterate on the subjects and runs
img_mask = get_mask(data_root)
stab_mask = '/Volumes/T7/BIDS-BRAINPLAYBACK-TASK2/derivatives/STAB_mask_smaller.nii.gz'
